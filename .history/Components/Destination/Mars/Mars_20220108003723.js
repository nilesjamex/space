...
import Moon from '../../../public/assets/destination/image-moon.jpg'
...
const Mars = () => {
    ...
    switch (steps) {
        ...
        <div>
        <Image src={Moon} height="100" width=" 70" alt="uu" />
        </div>
  ...
  <h3 className={styles.distancekm}>3 days</h3>
    ...
    return (
        <div className={styles.moon}>
        <div>
        <Image src='/../../../public/assets/destination/image-mars.png' height="100" width=" 70" alt="uu" />
        </div>
        <div className={styles.moontext}>
        <div>
        <ul className={styles.list}>
  ...
  <h3 className={styles.distancekm}>9 months</h3>
    ...
    return (
        <div className={styles.moon}>
        <div>
        <Image src='/../../../public/assets/destination/image-europa.png' height="100" width=" 70" alt="uu" />
        </div>
        <div className={styles.moontext}>
        <div>
        <ul className={styles.list}>
...
case 4:
    return (
         <div className={styles.moon}>
        <div>
        <Image src='/../../../public/assets/destination/image-titan.webp' height="100" width=" 70" alt="uu" />
        </div>
        <div className={styles.moontext}>
        <div>
        <ul className={styles.list}>
