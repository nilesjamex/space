...
import Marss from '../../../public/assets/destination/image-mars.png';
...
const Mars = () => {
  ...
  <h3 className={styles.distancekm}>3 days</h3>
    ...
    return (
        <div className={styles.moon}>
        <div>
        <Image src={Marss} height="445" width="445" alt="uu" />
        </div>
        <div className={styles.moontext}>
        <div>
        <ul className={styles.list}>
  ...
  <h3 className={styles.distancekm}>9 months</h3>
    ...
    return (
        <div className={styles.moon}>
        <div>
        <Image src={Europa} height="445" width="445" alt="uu" />
        </div>
        <div className={styles.moontext}>
        <div>
        <ul className={styles.list}>
...
case 4:
    return (
         <div className={styles.moon}>
        <div>
        <Image src={Titan} height="445" width="445" alt="uu" />
        </div>
        <div className={styles.moontext}>
        <div>
        <ul className={styles.list}>
