...
const Tech = () => {
    ...
    switch (steps) {
        ...
        <div className={styles.techhome}>
           ...
           <li 
           className={`${true1 ? style.number : style.number2}`} 
           onClick={(e) => {
               click1()
           }}>1</li>
           <li onClick={(e) => {
               next()
               click2()
               }} className={`${true2 ? style.number : style.number2}`}>2</li>
           <li  onClick={(e) => {
      setSteps(steps+2)
      click3()
      }} className={`${true3 ? style.number : style.number2}`}>3</li>
           </ul>
           </div> 
    ...
    case 2: return (
        <div className={styles.techhome}>
           ...
           <li
            ...
            className={`${true1 ? style.number : style.number2}`} >1</li>
           <li 
           className={`${true2 ? style.number : style.number2}`} 
           onClick={(e) => {
               click2()
           }}>2</li>
           <li 
      ...
      click1()
       ...
       className={`${true1 ? style.number : style.number2}`} >1</li>
           ...
           onClick={(e) => {
            ...
            className={`${true2 ? style.number : style.number2}`} >2</li>
           <li 
           className={`${true3 ? style.number : style.number2}`} 
           onClick={(e) => {
               click3()
           }}>3</li>
           </ul>
