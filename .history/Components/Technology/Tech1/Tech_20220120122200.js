...
const Tech = () => {
    ...
    switch (steps) {
        ...
        <div className={styles.techhome}>
           ...
           <li 
           className={`${true1 ? styles.number : styles.number2}`} 
           onClick={(e) => {
               click1()
           }}>1</li>
           <li onClick={(e) => {
               next()
               click2()
               }} className={`${true2 ? styles.number : styles.number2}`}>2</li>
           <li  onClick={(e) => {
      setSteps(steps+2)
      click3()
      }} className={`${true3 ? styles.number : styles.number2}`}>3</li>
           </ul>
           </div> 
  ...
  <Image className={styles.images} src={Vehicle2}   height="527" width="515" alt="uu" /> 
  </div>
        </div>
    );
    ...
    case 2: return (
        <div className={styles.techhome}>
           ...
           <li
            ...
            className={`${true1 ? styles.number : styles.number2}`} >1</li>
           <li 
           className={`${true2 ? styles.number : styles.number2}`} 
           onClick={(e) => {
               click2()
           }}>2</li>
           <li 
      ...
      click1()
       ...
       className={`${true1 ? styles.number : styles.number2}`} >1</li>
           ...
           onClick={(e) => {
            ...
            className={`${true2 ? styles.number : styles.number2}`} >2</li>
           <li 
           className={`${true3 ? styles.number : styles.number2}`} 
           onClick={(e) => {
               click3()
           }}>3</li>
           </ul>
